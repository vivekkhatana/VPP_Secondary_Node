# -*- coding: utf-8 -*-
"""
Created on Mon Oct  9 11:56:30 2023
...
def runOPT():
    ...
    while threadGo:
        ...
        if OPT_ON == 1: 
            ...
            logger.info("latest power_demand = " +str(power_demand))

            while (opt_iter < maxIter):

                if ( (AvgConsFlag == 1) and (myOpt_complete == 0) ): 
                    ...
                    Y = (1/(1+rho))*( rho*Z + coeff_b + power_demand - Lambda )
                    ...
                    if (AvgConsFlag == 1):
                        ...
                        PI_diff = (PI_max - PI_min)
                        
                        Y_diff = Y - coeff_b - PI_min
                
                        r = Y_diff/PI_diff 

                        dummy_var = np.abs(r)

                        r = dummy_var/( np.maximum(1,dummy_var) )
            ...
            if (myOpt_complete == 1) and (Opt_complete == 0):
                ...
                basic_secondary_thread.opt_final_result_to_primary(float(r))
